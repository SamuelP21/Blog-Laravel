            ...
            <form action="{{route('admin.post.update', $post)}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="flex items-center mb-4">
                    <input id="country-option-1" type="radio" name="status" value="1" 
                            ...
                            {{ old('status',$post->status , '1') == '1' ? 'checked' : '' }}>
                    ...
                    <input id="country-option-1" type="radio" name="status" value="2" 
                            ...
                            {{ old('status',$post->status ) == '2' ? 'checked' : '' }}>
                    <label for="country-option-1" class="block ms-2  text-sm font-medium text-gray-900 dark:text-gray-300">
                      Publicado
                    </label>
                  </div>
                ...
                <div class="flex items-center max-w-lg">
                    <div class="w-1/2">
                        ...
                        <img id="picture" class="h-auto max-w-full rounded-lg" src="@if($post->image) {{Storage::url($post->image->url)}} @else https://www.tooltyp.com/wp-content/uploads/2014/10/1900x920-8-beneficios-de-usar-imagenes-en-nuestros-sitios-web.jpg @endif" alt="image description">
                    </div>
                ...
                <div>
                    ...
                    <textarea name="extract" id="message" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="extracto...">{{old('extract', $post->extract)}}</textarea>
                </div>
                <div>
