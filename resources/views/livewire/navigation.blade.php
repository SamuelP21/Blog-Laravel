        ...
        <div class="relative flex h-16 items-center justify-between">
          ...
          @auth
            ...
            <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
              ...
              <!-- Profile dropdown agregandole propiedades con alphaine -->
              <div class="relative ml-3" x-data="{ open: false }">
                ...
                <!--
                  ...
                  Leaving: "transition ease-in duration-75"
                    ...
                    To: "transform opacity-0 scale-95" route('logout')
                -->
          ...
          @else 
            <div>
              <a href="{{route('login')}}" class="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium" role="menuitem" tabindex="-1" id="user-menu-item-2">login</a>
              <a href="{{route('register')}}" class="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium" role="menuitem" tabindex="-1" id="user-menu-item-2">register</a>
            </div>
          @endauth
        </div>
      </div>
      ...
      <div x-show="open" x-on:click.away="open=false" class="sm:hidden" id="mobile-menu">
        <div class="space-y-1 px-2 pb-3 pt-2">
          ...
          @foreach ($categories as $category)            
            ...
            <a href="{{route('posts.category', $category)}}" class="text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2<a href= text-base font-medium">{{$category->name}}</a>
